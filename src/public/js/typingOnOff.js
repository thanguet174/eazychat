...
//                 dataToEmit.isChatGroup = true;
//             }

//             // goi send message len server
//             $.post("/message/typing-on-off", dataToEmit, function(data){
//                 let dataToEmit = {
...
//                 socket.emit("user-is-typing", dataToEmit);
//                 //step7:
//                 // typingOff(divId);
//                 //step 8
